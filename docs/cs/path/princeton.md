...
**学习地址：** [COS326 函数式编程](https://hackway.org/docs/cs/freshman/programming/cos326)
...
**先修课程：** [COS217 编程系统导论](https://hackway.org/docs/cs/freshman/cpp/cos217)、[COS318 操作系统](https://hackway.org/docs/cs/sophomore/operating/cos318)、[COS333 高级编程技术](https://hackway.org/docs/cs/sophomore/software/cos333)  
