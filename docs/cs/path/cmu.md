...
**学习地址：** [15-112 编程和计算机科学基础](http://localhost:3000/docs/cs/freshman/first/cs15112)
...
**前置课程：** [15-112 编程和计算机科学基础](http://localhost:3000/docs/cs/freshman/first/cs15112)

**学习地址：** [15-121 数据结构简介](http://localhost:3000/docs/cs/freshman/datastructure/cs15121)
...
**学习地址：** [15-122 命令式计算原理](http://localhost:3000/docs/cs/freshman/datastructure/cs15122)
...
**学习地址：** [15-131 计算机科学家的伟大实用思想](http://localhost:3000/docs/cs/freshman/tools/cs15131)
...
**前置课程：** [15-121 数据结构简介](http://localhost:3000/docs/cs/freshman/datastructure/cs15121)、[15-151 计算机科学的数学基础](http://localhost:3000/docs/cs/freshman/math/cs15151)

**学习地址：** [15-150 函数式编程原理](http://localhost:3000/docs/cs/sophomore/functional/cs15150)
...
**学习地址：** [15-151 计算机科学的数学基础](http://localhost:3000/docs/cs/freshman/math/cs15151)

### ⑦ 15-210 并行和顺序数据结构和算法
了解算法设计中的各种技术，包括分治法、收缩法、随机化、贪心法、蛮力法、归约法和动态规划；了解并行技术，例如扫描（前缀和） 将问题抽象为正式定义的能力；给定定义设计新算法和数据结构的能力；了解渐近分析并解决各种递归；理解纯函数式算法。

**前置课程：** [15-150 函数式编程原理](http://localhost:3000/docs/cs/sophomore/functional/cs15150)、[15-122 命令式计算原理](http://localhost:3000/docs/cs/freshman/datastructure/cs15122)

**学习地址：** [15-210 并行和顺序数据结构和算法](http://localhost:3000/docs/cs/sophomore/algorithm/cs15210)
...
**前置课程：**  [15-122 命令式计算原理](http://localhost:3000/docs/cs/freshman/datastructure/cs15122)

**学习地址：** [15-213 计算机系统概论](http://localhost:3000/docs/cs/sophomore/system/cs15213)
...
**前置课程：** [15-121 数据结构简介](http://localhost:3000/docs/cs/freshman/datastructure/cs15121)、 [15-122 命令式计算原理](http://localhost:3000/docs/cs/freshman/datastructure/cs15122)、 [15-151 计算机科学的数学基础](http://localhost:3000/docs/cs/freshman/math/cs15151)

**学习地址：** [15-214 软件构建原理：对象、设计和并发](http://localhost:3000/docs/cs/sophomore/software/cs15214)
...
**学习地址：** [15-251 理论计算机科学的伟大思想](http://localhost:3000/docs/cs/junior/reasoning/cs15251)
...
**前置课程：** [15-150 函数式编程原理](http://localhost:3000/docs/cs/sophomore/functional/cs15150)、[15-251 理论计算机科学的伟大思想](http://localhost:3000/docs/cs/junior/reasoning/cs15251)

**学习地址：** [15-312 编程语言基础](http://localhost:3000/docs/cs/sophomore/programming/cs15312)
...
**前置课程：**  [15-214 软件构建原理：对象、设计和并发](http://localhost:3000/docs/cs/sophomore/software/cs15214)

**学习地址：** [15-313 软件工程基础](http://localhost:3000/docs/cs/sophomore/software/cs15313)
...
**前置课程：**  [15-213 计算机系统概论](http://localhost:3000/docs/cs/sophomore/system/cs15213)

**学习地址：** [15-319 云计算](http://localhost:3000/docs/cs/senior/cloud/cs15319)
...
**学习地址：** [15-440 分布式系统](http://localhost:3000/docs/cs/senior/distributed/cs15440)
...
**学习地址：** [15-441 计算机网络](http://localhost:3000/docs/cs/junior/network/cs15441)
...
**学习地址：** [15-445 数据库系统](http://localhost:3000/docs/cs/junior/database/cs15445)
...
**前置课程：**  [15-210 并行和顺序数据结构和算法](http://localhost:3000/docs/cs/sophomore/algorithm/cs15210)

**学习地址：** [15-451 算法设计与分析](http://localhost:3000/docs/cs/sophomore/algorithm/cs15451)
