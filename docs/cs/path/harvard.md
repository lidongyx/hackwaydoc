...
### ⑩ 143 计算机网络
计算机网络促成了移动计算和云计算的出现，创造了计算领域两项最重要的技术突破。如今，由于远程活动已成为一种新常态，计算机网络变得更加重要。我们预计未来几年会有几个重点。首先，我们将见证5G无线移动网络的出现，它已经开始取代目前的4G网络。其次，网络安全和隐私将受到业界前所未有的关注。第三，作为比特币基础的区块链技术为许多新的分布式应用程序创建了一个新的可信网络基础设施。第四，远程学习和虚拟会议将突破当前多播和网络管理技术的极限。
