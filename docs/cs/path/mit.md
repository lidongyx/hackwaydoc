...
**学习地址：** [6.0001 Python计算机科学编程导论](http://localhost:3000/docs/cs/freshman/first/cs60001)
...
**学习地址：** [6.042 计算机科学中的数学](http://localhost:3000/docs/cs/freshman/math/cs6042)
...
**前置课程：** [6.0001 Python计算机科学编程导论](http://localhost:3000/docs/cs/freshman/first/cs60001)

**学习地址：** [6.02 通过通信网络介绍 EECS](http://localhost:3000/docs/cs/freshman/first/cs602)

### ④ 6.004	计算架构
介绍了数字系统和计算机体系结构的设计。强调用高级硬件语言表达所有硬件设计并综合设计。主题包括组合和时序电路、可编程硬件的指令集抽象、单周期和流水线处理器实现、多级内存层次结构、虚拟内存、异常和 I/O 以及并行系统。

**前置课程：** 大学物理 II （这里就不介绍了）以及[6.0001 Python计算机科学编程导论](http://localhost:3000/docs/cs/freshman/first/cs60001)

**学习地址：** [6.004	计算架构](http://localhost:3000/docs/cs/sophomore/system/cs6004)

### ⑤ 6.006 算法概论
介绍计算问题的数学建模，以及用于解决这些问题的常用算法、算法范式和数据结构。强调算法和编程之间的关系，并介绍这些问题的基本性能测量和分析技术。注册可能会受到限制。

**前置课程：** [6.042 计算机科学中的数学](http://localhost:3000/docs/cs/freshman/math/cs6042)、[6.0001 Python计算机科学编程导论](http://localhost:3000/docs/cs/freshman/first/cs60001)、[6.009 编程基础](http://localhost:3000/docs/cs/sophomore/software/cs6009)

**学习地址：** [6.006 算法概论](http://localhost:3000/docs/cs/freshman/datastructure/cs6006)
...
**学习地址：** [6.009 编程基础](http://localhost:3000/docs/cs/sophomore/software/cs6009)
...
**前置课程：** [6.009 编程基础](http://localhost:3000/docs/cs/sophomore/software/cs6009)

**学习地址：** [6.031 软件构建要素](http://localhost:3000/docs/cs/sophomore/software/cs6031)
...
**前置课程：** [6.004	计算架构](http://localhost:3000/docs/cs/sophomore/system/cs6004)、[6.009 编程基础](http://localhost:3000/docs/cs/sophomore/software/cs6009)

**学习地址：** [6.033 计算机系统工程](http://localhost:3000/docs/cs/sophomore/system/cs6033)

### ⑨ 6.046 算法设计与分析
设计和分析有效算法的技术，强调在实践中有用的方法。主题包括排序；搜索树、堆和散列；分而治之；动态规划；贪心算法；摊销分析；图算法；和最短路径。高级主题可能包括网络流；计算几何；数论算法；多项式和矩阵计算；缓存；和并行计算。

**前置课程：** [6.006 算法概论](http://localhost:3000/docs/cs/freshman/datastructure/cs6006)

**学习地址：** [6.046 算法设计与分析](http://localhost:3000/docs/cs/sophomore/algorithm/cs6046)

## 进阶推荐课程
### ① 6.824 分布式系统
本课程介绍分布式系统设计的抽象和实现技术。主题包括：服务器设计、网络编程、命名、存储系统、安全性和容错能力。

**前置课程：** [6.033 计算机系统工程](http://localhost:3000/docs/cs/sophomore/system/cs6033)

**学习地址：** [6.824 分布式系统](http://localhost:3000/docs/cs/senior/distributed/cs6824)
...
**前置课程：** [6.031 软件构建要素](http://localhost:3000/docs/cs/sophomore/software/cs6031)、[6.033 计算机系统工程](http://localhost:3000/docs/cs/sophomore/system/cs6033)

**学习地址：** [6.828 操作系统工程](http://localhost:3000/docs/cs/sophomore/operating/cs6828)
...
**学习地址：** [6.829 计算机网络](http://localhost:3000/docs/cs/junior/network/cs6829)
...
**前置课程：** [6.033 计算机系统工程](http://localhost:3000/docs/cs/sophomore/system/cs6033)、[6.006 算法概论](http://localhost:3000/docs/cs/freshman/datastructure/cs6006)、[6.046 算法设计与分析](http://localhost:3000/docs/cs/sophomore/algorithm/cs6046)

**学习地址：** [6.830 数据库系统](http://localhost:3000/docs/cs/junior/database/cs6830)
